  ...
  <div class="weui-cells_radio" :class="disabled ? 'vux-radio-disabled' : ''">
    <label class="weui-cell weui-cell_radio weui-check__label" :for="`radio_${uuid}_${index}`" v-for="(one, index) in options">
      ...
      <div class="weui-cell__ft">
        ...
        <img class="weui-icon-radio" src="../../assets/circle.png" v-if="currentValue !== getKey(one)">
        <img class="weui-icon-radio" src="../../assets/circle-active.png" v-if="currentValue === getKey(one)">
        <!--<span class="weui-icon-checked"></span>-->
      </div>
    </label>
    <div class="weui-cell" v-show="fillMode">
      <div class="weui-cell__hd"><label class="weui-label">{{ fillLabel }}</label></div>
      <div class="weui-cell__bd">
...
import { getValue, getKey, getLabel } from '../../utils/index';
